...
function App() {
    ...
    useEffect(() => {
        setTodolists(todoFromServer.map(el => ({ ...el, todolistsId: v1() })))
    }, [])
    ...
    function removeTask(id: string, todolistId: string) {
        ...
        // setTasks({ ...tasks });
        setTodolists(todolists.map(el => el.todolistsId === todolistId
    ...
    function removeTodolist(id: string) {
        ...
        // // засетаем в стейт копию объекта, чтобы React отреагировал перерисовкой
        // setTasks({ ...tasks });
        setTodolists(todolists.filter(el => el.todolistsId !== id))
    }
